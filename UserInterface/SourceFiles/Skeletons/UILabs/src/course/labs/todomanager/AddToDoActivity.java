	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		submitButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				//TODO - Get Priority
				int pId = mPriorityRadioGroup.getCheckedRadioButtonId();
				Priority priority = Priority.LOW;
				if (pId == R.id.medPriority) priority = Priority.MED;
				else if (pId == R.id.highPriority) priority = Priority.HIGH;

				//TODO -  Get Status
				Status status = Status.DONE;
				int sId = mStatusRadioGroup.getCheckedRadioButtonId();
				if (sId == R.id.statusNotDone) status = Status.NOTDONE;
